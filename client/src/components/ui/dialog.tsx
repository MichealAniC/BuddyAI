...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-button p-1 text-text-muted opacity-70 transition-opacity hover:opacity-100 hover:bg-surface-secondary focus:outline-none focus:ring-2 focus:ring-primary-300">
        <X className="h-4 w-4" />
